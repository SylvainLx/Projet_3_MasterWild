    ...
    <div className="top-page">
      ...
      <div className="intro-wsc">
        <p>
          ...
          travers une vingtaine de campus, à distance ou au sein d’entreprises.
          <br />
          Notre pédagogie hybride, basée sur la pratique et la réalisation de
          projets, associe notre plateforme éducative à un réseau de plus de 50
          formateurs dédiés.
          <br />
          ...
          proposant à nos élèves un environnement d'apprentissage accueillant et
          bienveillant.
          <br />
